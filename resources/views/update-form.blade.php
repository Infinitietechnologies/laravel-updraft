...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Project Updater') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('project-updater.upload') }}" enctype="multipart/form-data">
                        @csrf
                        
                        <div class="mb-3">
                            <label for="update_package" class="form-label">Update Package</label>
                            <input class="form-control @error('update_package') is-invalid @enderror" 
                                   type="file" 
                                   id="update_package" 
                                   name="update_package"
                                   accept=".zip">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" value="1" id="confirm_backup" name="confirm_backup" required>
