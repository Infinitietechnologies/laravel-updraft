/**
 * Laravel Updraft - Main JavaScript
    ...
    if (document.getElementById('update_package') && document.getElementById('uploadForm')) {
        ...
        if (typeof FilePondUploader !== 'undefined') {
            FilePondUploader.init({
                ...
                processUrl: getRouteUrl('laravel-updraft.process-file'),
                revertUrl: getRouteUrl('laravel-updraft.revert-file'),
                uploadUrl: getRouteUrl('laravel-updraft.upload'),
                csrfToken: csrfToken
            });
        }
    }
    ...
    if (document.getElementById('rollbackForm') && document.getElementById('confirmBtn')) {
        ...
        if (typeof RollbackHandler !== 'undefined') {
            RollbackHandler.init({
                ...
                redirectUrl: getRouteUrl('laravel-updraft.history') + '?success=1',
                csrfToken: csrfToken
            });
        }
    }
